      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.Anno = Anno = (function () {
          ...
          function Anno(arg) {
            ...
            if (options instanceof Anno) {
              console.warn(
                "Anno constructor parameter is already an Anno object."
              );
            }
            if (options == null) {
              console.warn(
                "new Anno() created with no options. It's recommended" +
          ...
          Anno.prototype.show = function () {
            ...
            if (
              this.autoFocusLastButton &&
              $target.find(":focus").length === 0
            ) {
              lastButton.focus();
            }
          ...
          Anno.prototype.onHide = function (
            anno,
            $target,
            $annoElem,
            returnFromOnShow
          ...
          Anno.prototype.targetFn = function () {
            ...
            if (typeof this.target === "string") {
              ...
              if (r.length === 0) {
                console.error(
                  "Couldn't find Anno.target '" + this.target + "'."
                );
              }
              if (r.length > 1) {
                console.warn(
              ...
              console.error(
                "Unrecognised Anno.target. Please supply a jQuery " +
          ...
          Anno.prototype.annoElem = function () {
            this._annoElem = $(
              "<div class='anno anno-hidden " +
                this.className +
                "'>\n<div class='anno-inner'>  <div class='anno-arrow'></div>  </div>\n</div>"
            );
            this._annoElem
              .find(".anno-inner")
              .append(this.contentElem())
              .append(this.buttonsElem());
          ...
          Anno.prototype.contentElem = function () {
            return $(
              "<div class='anno-content'>" + this.contentFn() + "</div>"
            );
          };
          ...
          Anno.prototype.showOverlay = function () {
            ...
            if ($(".anno-overlay").length === 0) {
              $("body").append(
                ($e = this.overlayElem().addClass("anno-hidden"))
              );
              return setTimeout(function () {
          ...
          Anno.prototype.overlayElem = function () {
            return $(
              "<div class='anno-overlay " + this.overlayClassName + "'></div>"
            ).click(
              (function (_this) {
                return function (evt) {
          ...
          Anno.prototype.emphasiseTarget = function ($target) {
            ...
            if ($target.css("position") === "static") {
              $target.after(
                (placeholder = $target.clone().addClass("anno-placeholder"))
              );
              (function (_this) {
            ...
            switch (pos) {
              ...
              case "center-bottom":
                annoEl.css({
                  left:
                    offset.left +
                    ($targetEl.outerWidth() / 2 - annoEl.outerWidth() / 2) +
                    "px",
                });
                break;
              case "left":
              ...
              case "center-right":
                annoEl.css({
                  top:
                    offset.top +
                    ($targetEl.outerHeight() / 2 - annoEl.outerHeight() / 2) +
                    "px",
                });
            }
            switch (pos) {
          ...
          Anno.prototype.positionFn = function () {
            ...
            if (this.position != null) {
              ...
              if (allowed.length === 0) {
                console.error(
                  "Anno couldn't guess a position for '" +
                    this.target +
                    "'. " +
                ...
                console.warn(
                  "Anno: guessing position:'" +
                    allowed[0] +
                    "' for " +
                    ("'" +
                      this.target +
                      "'. Possible Anno.preferredPositions: [" +
                      allowed +
                      "].")
                );
              }
          ...
          Anno.prototype.buttonsElem = function () {
            var b;
            return $("<div class='anno-btn-container'></div>").append(
              function () {
        ...
        exports.AnnoButton = AnnoButton = (function () {
          ...
          AnnoButton.prototype.buttonElem = function (anno) {
            return $("<button type='button' class='anno-btn'></button>")
              .html(this.textFn(anno))
        ...
        (function ($) {
          ...
          var borders = function (domElement, styles) {
            styles =
              ...
              (document.defaultView && document.defaultView.getComputedStyle
                ? document.defaultView.getComputedStyle(domElement, null)
              ...
              top:
                parseFloat(
                  px
                    ...
                    : $.css(domElement, "borderTopWidth")
                ) || 0,
              left:
                parseFloat(
                  px
                    ? styles.borderLeftWidth
                    : $.css(domElement, "borderLeftWidth")
                ) || 0,
              bottom:
                parseFloat(
                  px
                    ? styles.borderBottomWidth
                    : $.css(domElement, "borderBottomWidth")
                ) || 0,
              right:
                parseFloat(
                  px
                    ? styles.borderRightWidth
                    : $.css(domElement, "borderRightWidth")
                ) || 0,
            };
            return {
              top: b.top,
          ...
          var dimensions = function ($element) {
            ...
            return {
              ...
              scrollbar: {
                right: isRoot
                  ? 0
                  : $element.innerWidth() - $element[0].clientWidth,
                bottom: isRoot
                  ? 0
                  : $element.innerHeight() - $element[0].clientHeight,
              },
              rect: (function () {
              ...
              if (scroller.length > 0) {
                ...
                var rel = {
                  ...
                  bottom:
                    dim.s.rect.bottom -
                    dim.s.border.bottom -
                    dim.s.scrollbar.bottom -
                    dim.e.rect.bottom,
                  left: dim.e.rect.left - (dim.s.rect.left + dim.s.border.left),
                  right:
                    dim.s.rect.right -
                    dim.s.border.right -
                    dim.s.scrollbar.right -
                    dim.e.rect.right,
                };
                ...
                if (options.direction.y === true) {
                  if (rel.top < 0) {
                    ...
                    animOptions.scrollTop =
                      dim.s.scroll.top + Math.min(rel.top, -rel.bottom);
                  }
                }
                ...
                if (options.direction.x === true) {
                  if (rel.left < 0) {
                    ...
                    animOptions.scrollLeft =
                      dim.s.scroll.left + Math.min(rel.left, -rel.right);
                  }
                }
          ...
          $.extend($.expr[":"], {
            scrollable: function (element, index, meta, stack) {
              var direction =
                converter[
                  typeof meta[3] === "string" && meta[3].toLowerCase()
                ] || converter.both;
              var styles =
                document.defaultView && document.defaultView.getComputedStyle
              ...
              var size = {
                ...
                scrollableX: function () {
                  return (
                    (overflow.x || overflow.isRoot) &&
                    this.width.scroll > this.width.client
                  );
                },
                scrollableY: function () {
                  return (
                    (overflow.y || overflow.isRoot) &&
                    this.height.scroll > this.height.client
                  );
                },
              };
              return (
                (direction.y && size.scrollableY()) ||
